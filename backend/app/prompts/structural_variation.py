...
Set `diagram_required` only when a diagram is necessary to solve the question. If any primary seed includes diagram context, preserve the visual reasoning with a new matching diagram. Its `diagram_render_spec` must be answer-independent and list exact geometry and labels.
