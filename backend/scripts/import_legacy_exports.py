...
This copy lives in the API build context so it is available in the Railway
container. The source inventory command remains at scripts/inventory_railway_data.py.
"""
