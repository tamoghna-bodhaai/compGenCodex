...
export function DashboardScreen() {
  ...
  async function controlGeneration(paper: PaperSummary, action: "pause" | "resume" | "cancel") {
    ...
    try {
      if (action === "cancel" && !window.confirm("Cancel this generation? Completed work will be kept and remain available to view.")) return;
      ...
      else toast("Generation cancelled. Completed questions remain available to view.");
